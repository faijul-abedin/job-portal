              ...
              ">
                ...
                <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
                    <div class="mx-auto flex max-w-2xl items-center justify-between lg:mx-0 lg:max-w-none">
                        <Link class="mb-8 flex flex-row items-center justify-center gap-2 rounded-lg border border-gray-600 bg-gray-50/10 px-4 py-2.5 text-sm font-medium text-gray-200 transition hover:bg-gray-800/30 hover:text-blue-700 hover:text-white focus:z-10 focus:outline-none"
