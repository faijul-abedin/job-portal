                    ...
                    <div class="mx-auto max-w-7xl px-6 lg:px-8">
                        <div class="mx-auto max-w-2xl text-center">
                            <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">
                                <span class="font-extrabold text-indigo-300">Job Portal</span> Single Page Job searching board.
                            </h1>
                ...
                <div class="grid grid-cols-12 lg:gap-12">
                    <div class="col-span-12" id="find-job">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <p class="text-base text-white/60">{{ job_count }} </p>
                            ...
                            <!-- @forelse ($jobs as $job) -->
                                ...
                                <div v-for="job in jobs.data"
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex flex-col items-start gap-6 md:flex-row md:items-center">
                                            ...
                                            <div>
                                                ...
                                                <h6
                                                    ...
                                                    <Link :href="route('frontend.job_details', job.id)"> {{ job.title }}
                                                    </Link>
                                                </h6>
                                        ...
                                        <Link class="hidden items-center gap-1.5 rounded-lg bg-gray-300/30 px-4 py-2.5 text-indigo-300 transition group-hover:bg-indigo-500 group-hover:text-white group-hover:duration-500 md:flex"
